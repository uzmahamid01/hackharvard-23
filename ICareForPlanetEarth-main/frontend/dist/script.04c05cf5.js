...
function _runAsyncCode() {
  _runAsyncCode = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var viewer, cesiumContainer, backgroundColor, buildingTileset, convertScreenPixelToLocation, setMarkerInPos;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          backgroundColor = getComputedStyle(cesiumContainer).backgroundColor; // Set the background color of the body
