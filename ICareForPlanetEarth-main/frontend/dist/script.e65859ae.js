...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"src/components/js/script.js":[function(require,module,exports) {
...
function _runAsyncCode() {
  _runAsyncCode = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var viewer, animateCamera, axios, convertScreenPixelToLocation, setMarkerInPos;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          setMarkerInPos = function _setMarkerInPos(position) {
          ...
          convertScreenPixelToLocation = function _convertScreenPixelTo(mousePosition) {
          ...
          animateCamera = function _animateCamera() {
            viewer.scene.light.intensity = 10.0;
            // Coordinates for the initial camera destination (zoom-in)
            var initialDestination = Cesium.Cartesian3.fromDegrees(-100.0, 49.0, 8500000);

            // Coordinates for the final camera destination (zoom-out)
            var finalDestination = Cesium.Cartesian3.fromDegrees(-100.0, 40.0, 18000000);
          ...
          viewer.scene.canvas.addEventListener('contextmenu', function (event) {
            ...
            var selectedLocation = convertScreenPixelToLocation(mousePosition);
          ...
          viewer.screenSpaceEventHandler.setInputAction(function (click) {
            var pickedLocation = viewer.scene.pickPosition(click.position);
            if (Cesium.defined(pickedLocation)) {
              ...
              Cesium.sampleTerrainMostDetailed(viewer.terrainProvider, [Cesium.Cartographic.fromCartesian(pickedLocation)]).then(function (updatedCartographics) {
                var cartographic = updatedCartographics[0];
                var longitude = Cesium.Math.toDegrees(cartographic.longitude);
                var latitude = Cesium.Math.toDegrees(cartographic.latitude);
                var heightAboveGround = 1000;
                var height = cartographic.height + heightAboveGround;
                ...
                var backendUrl = 'http://localhost:8080'; // Update with your back-end URL

                // Make an HTTP POST request to your back end
                axios.post("".concat(backendUrl, "/your-endpoint"), jsonData, {
                  headers: {
                    'Content-Type': 'application/json'
                  }
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/components/js/script.js"], null)
//# sourceMappingURL=/script.e65859ae.js.map